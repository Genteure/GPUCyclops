...
namespace Media.Formats.JPGFJCore
{
    ...
    {
        private FJImage _image; public FJImage Image { get { return _image; } }
        ...
        public IList<JpegHeader> MetaHeaders { get { return _metaHeaders.AsReadOnly(); } }
				...
				public DecodedJpeg(FJImage image, IEnumerable<JpegHeader> metaHeaders)
        {
            _image = image;
            ...
            Initialize();
				...
				public DecodedJpeg(FJImage image)
            : this(image, null)
        {

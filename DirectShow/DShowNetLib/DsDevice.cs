...
namespace DShowNET.Device
{
	...
	public class DsDev
	{
        ...
        /// <summary>Create From CLSID</summary>
        public static Object CreateFromCLSID(Guid clsid)
        {
            Type comType = null;
            comType = Type.GetTypeFromCLSID(clsid);
            if (comType == null)
                throw new NotImplementedException(@"Directshow object not installed/registered!");
